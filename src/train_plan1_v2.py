...
# --- 1. CONFIGURATION (PLAN 1 v2: WIDTH + REGULARIZATION) ---
HIDDEN_SIZE = 64        # Increased capacity
EMBED_DIM = 64          # Increased capacity
NUM_CLASSES = 5
NUM_EPOCHS = 40         # Extended training time
BATCH_SIZE = 16
LEARNING_RATE = 0.001
...
# --- 4. MODEL ARCHITECTURE (PLAN 1 v2) ---
...
# NEW: Weight Decay added here
optimizer = optim.Adam(model.parameters(), lr=LEARNING_RATE, weight_decay=WEIGHT_DECAY)

train_losses = []
val_accuracies = []

print(f"\n--- Plan 1 v2 Started: Width + L2 Reg (Hidden={HIDDEN_SIZE}, Reg={WEIGHT_DECAY}) ---")
...
plt.legend()
plt.tight_layout()
plt.savefig('learning_curve_plan1_v2.png')
print("Learning curve saved: learning_curve_plan1_v2.png")
...
metrics_file = "plan1_v2_metrics.txt"
with open(metrics_file, "w") as f:
    f.write("Plan 1 v2 Model Evaluation Metrics\n")
    f.write("==================================\n")
...
plt.ylabel('True')
plt.title('Confusion Matrix - Plan 1 v2')
plt.savefig('confusion_matrix_plan1_v2.png')
print("Confusion Matrix saved: confusion_matrix_plan1_v2.png")